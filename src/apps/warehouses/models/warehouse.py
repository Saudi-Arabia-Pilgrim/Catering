...
from apps.warehouses.utils import new_id
...
class Warehouse(AbstractBaseModel):
    ...
    """
    # === A unique identifier for the warehouse. Defaults to a value generated by the `new_id` function. ===
    warehouse_id = models.CharField(default=new_id, unique=True)
